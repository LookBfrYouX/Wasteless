...
public class ProductController {
   ...
   *     Null
   * @param sortBy Defines any product sorting needed and the direction (ascending or descending).
   *     In the format "fieldName-<acs/desc>", Can be Null
  ...
  public ResponseEntity<List<BasicProductDto>> showBusinessCatalogue(
