...
describe("Date string format", () => {
  test("standard jan", () => {
    expect(wrapper.vm.formatDate(new Date(2000, 0, 1))).toEqual("1 January, 2000");
  });

  test("standard dec", () => {
    expect(wrapper.vm.formatDate(new Date(2000, 11, 31))).toEqual("31 December, 2000");
  });

  test("ISO string", () => {
    expect(wrapper.vm.formatDate("2021-03-02T05:35:03")).toEqual("2 March, 2021");
  });
